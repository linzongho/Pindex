...
// Avoid conflicting when `sea.js` is loaded multiple times
    ...
    var isObject = isType("Object");// called like 'isObject(obj) === true'
    ...
    /**
     * Remove event.
     * If `callback` is undefined, remove all callbacks for the event.
    ...
    seajs.off = function(name, callback) {
        if (!(name || callback)) {/* Remove *all* events */
            events = data.events = {};
        }else{
