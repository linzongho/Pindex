...
<?php } ?>
<td><?php echo "<input type='image' class='icon' name='add[" . (support("move_col") ? 0 : count($fields)) . "]' src='static/adminer/plus.gif' alt='+' title='" . lang('Add next') . "'>"; ?><script type="text/javascript">row_count = <?php echo count($fields); ?>;</script>
</thead>
...
<?php
		...
		echo (support("move_col") ?
			"<input type='image' class='icon' name='add[$i]' src='static/adminer/plus.gif' alt='+' title='" . lang('Add next') . "' onclick='return !editingAddRow(this, 1);'>&nbsp;"
			. "<input type='image' class='icon' name='up[$i]' src='static/adminer/up.gif' alt='^' title='" . lang('Move up') . "'>&nbsp;"
			. "<input type='image' class='icon' name='down[$i]' src='static/adminer/down.gif' alt='v' title='" . lang('Move down') . "'>&nbsp;"
		: "");
		echo ($orig == "" || support("drop_col") ? "<input type='image' class='icon' name='drop_col[$i]' src='static/adminer/cross.gif' alt='x' title='" . lang('Remove') . "' onclick=\"return !editingRemoveRow(this, 'fields\$1[field]');\">" : "");
		echo "\n";
	}
}
...
function doc_link($paths) {
	...
	$urls = array(
		...
		'pgsql' => "http://www.postgresql.org/docs/" . substr($connection->server_info, 0, 3) . "/static/adminer/",
